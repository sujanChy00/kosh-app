...
const buttonVariants = cva('flex-row items-center justify-center gap-2', {
  variants: {
    variant: {
      ...
      secondary: 'ios:active:opacity-80 bg-secondary',
      muted: 'ios:active:opacity-80 bg-muted dark:bg-muted-foreground',
    ...
    size: {
      ...
      flat: 'ios:rounded-lg py-2 ios:py-1.5 ios:px-3.5 px-5',
    },
  },
  defaultVariants: {
    variant: 'primary',
...
const ANDROID_RIPPLE = {
  dark: {
    ...
    secondary: { color: convertToRGBA(COLORS.dark.grey3, 0.4), borderless: false },
    destructive: { color: convertToRGBA(COLORS.dark.grey, 0.3), borderless: false },
    outline: { color: convertToRGBA(COLORS.dark.grey, 0.4), borderless: false },
  ...
  light: {
    ...
    secondary: { color: convertToRGBA(COLORS.light.grey4, 0.4), borderless: false },
    destructive: { color: convertToRGBA(COLORS.light.grey6, 0.4), borderless: false },
    outline: { color: convertToRGBA(COLORS.light.grey5, 0.8), borderless: false },
    ...
    muted: { color: convertToRGBA(COLORS.light.grey2, 0.4), borderless: false },
  },
};
